...
print("\n\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t--------------------")
print("\t\t\t🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵\t\tLogin "
      "Page\t\t🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵_🔵")
print("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t____________________")
user=input("\n\n👉🏻ENTER USERNAME\t\t\t\t:")
passwords=input("\n\n👉🏻ENTER PASSWORD\t\t\t\t:")
print("Checking Username And Password. Please Wait.....")
sleep(1.5)


# ____________________________________________________________________________________________________________________________________________________

if user == "root" and passwords == '2002':
...
# ..........................................................................................................................................................
        ...
        def insert3():
            ...
            sql = "insert into Station(s_name, notrain, nopltfrm, no_employees, no_counter, station_code)  " \
                  "values('%s','%d','%d','%d','%d','%s')" \
                  % (s_name, notrain, nopltfrm, no_employees, no_counter, station_code)
            try:
                cursor.execute(sql)
                db.commit()
            except:
...
# ___________________________________________________________________________________________________________________________________________________________
        ...
        def view3():
            ...
            sql = "select * from Station where station_code='%s'" % tempst
            cursor.execute(sql)
            results = cursor.fetchall()
            for c in results:
                s_no = c[0]
...
# ..........................................................................................................................................................
        ...
        def display3():
            try:
                sql = "select * from Station order by s_no"
                cursor.execute(sql)
                results = cursor.fetchall()
                for c in results:
                    s_no = c[0]
...
# ..........................................................................................................................................................
        ...
        def delete3():
            ...
            def modified():
                sql3 = "select * from Station where station_code='%s'" % tempst
                cursor.execute(sql3)
                results = cursor.fetchall()
                for c in results:
                    s_no = c[0]
            ...
            try:
                sql = "delete from Station where station_code='%s'" % tempst
                ans = input("Are you sure want to delete the given entry(yes/no)")
                if ans == 'yes' or ans == 'Yes':
                    cursor.execute(sql)
                    db.commit()
...
# ___________________________________________________________________________________________________________________________________________________________
    ...
    print("🚫️🙁 Incorrect Username or Password..️🙁🚫")

# ____________________________________________________________THE_END__________________________________________________________________________________________
